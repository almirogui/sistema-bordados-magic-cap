...
class Bordados_Ajax_Cliente {
    ...
    public function criar_pedido() {
        ...
        try {
            ...
            // ============================================
            // ✅ 2026-01-13: DISPARAR HOOK PARA EMAILS DE CONFIRMAÇÃO
            // ============================================
            // Este hook dispara:
            // 1. Email de confirmação para o CLIENTE (inglês)
            // 2. Notificação para o ADMIN puncher@puncher.com (português)
            // ============================================
            do_action('bordados_pedido_criado', $pedido_id, $cliente_id);
            error_log("📧 Hook 'bordados_pedido_criado' disparado para pedido #{$pedido_id}");
